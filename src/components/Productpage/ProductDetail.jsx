...
const ProductDetail = ({ product, onClose, onAddToCart, onBuyNow }) => {
  ...
  return (
    <>
      <Helmet>
        <title>{product.name} | Aqua Tech RO System Madurai</title>

        <meta
          name="description"
          content={`Buy ${product.name} in Madurai at best price. Aqua Tech RO System offers installation, service, and same day delivery. Call 9843021579`}
        />

        <meta
          name="keywords"
          content={`RO purifier ${product.name}, buy RO Madurai, water purifier Madurai, Aqua Tech RO System`}
        />

        <meta property="og:title" content={product.name} />
        <meta
          property="og:description"
          content={`Best RO purifier in Madurai - ${product.name}`}
        />
